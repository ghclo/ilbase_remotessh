...
class TunnelServer(object):
    def __init__(self, local_addr, local_port, remote_addr, remote_user_name, remote_password, remote_scm_url):
        ...
        self.client = None
        self.ws = None
        self.remote_scm_url = remote_scm_url
    ...
    def is_port_set_to_default(self):
        ...
        if ".scm.azurewebsites.net" not in self.remote_scm_url:
        ...
        url = '{}{}'.format(self.remote_scm_url, '/AppServiceTunnel/Tunnel.ashx?GetStatus')
        r = http.request(
            'GET',
            url,
            headers=headers,
    ...
    def _listen(self):
        ...
        while True:
            ...
            host = '{}{}'.format(self.remote_scm_url.replace("https://","wss://"), '/AppServiceTunnel/Tunnel.ashx')
